...
-->
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="{{url('/')}}" class="logo">
                            <img style="margin-top: 20px;" src="assets/images/klassy-logo.png" align="klassy cafe html template">
    ...
    <div id="top">
        ...
        <h1 style="font-size: 30px;">Thank you for your order</h1>
        <p>A confirmation email was sent.</p>

        <br>
        <button class="btn btn-success"><a href="{{url('/')}}" style="text-decoration: none; color:white;">← Continue Shop</a></button>
